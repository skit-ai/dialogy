...
def test_duckling_api_success():
    ...
    expected_response = [{'body': 'four',
                         ...
                         {'body': 'at 5 am',
                          'start': 55,
                          'value': {'values': [{'value': '2020-12-24T05:00:00.000-08:00',
                                                'grain': 'hour',
                                                'type': 'value'},
    ...
    def request_callback(request, _, response_headers):
        ...
        assert content_type == duckling_header, f"expected {duckling_header} but received Content-Type: {content_type}"
